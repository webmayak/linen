...
function display(view) {
    if (view == 'list') {
        ...
        $('.product_list > li').each(function(index, element) {
            ...
            var price = $(element).find('.content_price');
            if (price != null) {
        ...
        $('.product_list > li').removeClass('col-xs-12').addClass('col-xs-6 col-sm-' + 12 / nbItemsPerLineTablet + ' col-md-' + 12 / nbItemsPerLine);
        $('.product_list > li').each(function(index, element) {
            var html = '';
